...
struct Socket[AddrType: Addr, address_family: AddressFamily = AddressFamily.AF_INET](
    ...
    fn receive(self, size: Int = default_buffer_size) raises -> Bytes:
    ...
    fn receive_from(mut self, size: Int = default_buffer_size) raises -> (Bytes, String, UInt16):
    ...
    fn receive_from(mut self, mut dest: Bytes) raises -> (UInt, String, UInt16):
        """Receive data from the socket into the buffer dest.
